...
public class BrandAndProductSeeder
{
    ...
    private IEnumerable<Product> GetProducts()
    {
		...
		{
			new Product { BrandId = 1, Price = 39.99m,
			...
			new Product { BrandId = 1, Price = 209.99m,
			...
			new Product { BrandId = 1, Price = 519.99m,
			...
			new Product { BrandId = 2, Price = 429.99m,
			...
			new Product { BrandId = 2, Price = 299.99m,
			...
			new Product { BrandId = 3, Price = 339.99m,
